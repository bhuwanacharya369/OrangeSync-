...
export default function NotificationBell() {
   ...
   return (
      <div className="relative" ref={menuRef}>
         ...
         {isOpen && (
            <div className="absolute right-0 top-14 w-72 sm:w-80 bg-white rounded-2xl shadow-2xl border border-orange-100/50 z-50 overflow-hidden animate-in slide-in-from-top-2 transform origin-top-right">
